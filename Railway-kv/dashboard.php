  ...
  <style>
    ...
    background-repeat: no-repeat;background-size: cover;}
		...
		<!-- Header -->
            ...
            <li><strong><a href="index.php?logout=1">LOGOUT</a></strong></li>
			...
			<section id="banner">
				<div class="inner">
					<h1 align="center">WELCOME TO THE INDIAN RAILWAYS</h1>
          <h3 align="center">Online eTicketing system.</h3>
          <h4 align="center"> <ul style="list-style:none;">
            <li>Book Tickets</li>
            ...
            <li>Check Prices</li>
					...
					<!-- <ul class="actions" style="list-style:none;">
						<li><a href="index.php?logout=1" class="button big special">Logout</a></li>
					</ul> -->
				</div>
			</section>
