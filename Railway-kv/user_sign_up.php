...
<form action="?" method ="post">
  <div class="container2">
    ...
    <div class="clearfix">
      ...
      <a href="login.php" align="center"><button type="button" class="button special">Login</button></a>
    </div>
  </div>
</form>
...
if(array_key_exists('email', $_POST) AND array_key_exists('password', $_POST)){
    ...
    $dbPass = "linux123";            //Database Password
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        if(mysqli_query($db ,"INSERT INTO `users`(`username`, `password`) VALUES ('$usr','$pas') ") == TRUE){
           echo "<p><script>alert('User Created : Please Login'); window.location='login.php'</script></p>";
                   exit;
        }
